...
/*
$Id: nusoap.php,v 1.3 2007/04/13 10:50:58 sanjeev.m Exp $
...
* @version  $Id: nusoap.php,v 1.3 2007/04/13 10:50:58 sanjeev.m Exp $
* @access   public
*/
class nusoap_base {
...
$serviceurl = defined('C_SERVICE_URL') ? C_SERVICE_URL : $SERVICE_URL;
...
* $soapclient_nusoap = new soapclient_nusoap( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $soapclient_nusoap->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($soapclient_nusoap);
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: nusoap.php,v 1.3 2007/04/13 10:50:58 sanjeev.m Exp $
* @access   public
...
class soapclient_nusoap extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclient_nusoap($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false){
