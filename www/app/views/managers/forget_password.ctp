...
<div class="content_content">
	...
	<?php
		echo $form->create('User', array('url' => array('controller' => 'managers', 'action' => 'forget_password',$step ,$email, $key))).
...
<div class="content_content">
    <?php
        echo $form->create('User', array('url' => array('controller'=>'managers' , 'action'=>'forget_password')))
